...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback,
        ...
        ForecastFragment.ForecastLoadFinishedListener {
    ...
    private void sendWeatherData(String maxTemperature, String minTemperature, Bitmap bitmap) {
        ...
        putDataMapReq.getDataMap().putAsset(WEATHER_BITMAP_KEY, asset);
    ...
    @Override
    public void onForecastLoadFinished(String maxTemperature, String minTemperature, Bitmap bitmap) {
        sendWeatherData(maxTemperature, minTemperature, bitmap);
    }
}
